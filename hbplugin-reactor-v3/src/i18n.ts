...
export default {
    "havent_received_all_mods": {
        "en": "The server failed to receive all of your mods, please try again",
    ...
    "reactor_required_on_server": {
        "en": "This server requires you to have Reactor, see https://reactor.gg/ for more information",
    ...
    "reactor_not_enabled_on_server": {
        "en": "Reactor is not enabled on this server, please disable it",
    ...
    "reactor_required_for_room": {
        "en": "This room requires you to have Reactor, see https://reactor.gg/ for more information",
    ...
    "reactor_not_enabled_for_room": {
        "en": "Reactor is not enabled for this room, please disable it",
